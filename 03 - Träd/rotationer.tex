...
\section*{Enkel}
\includegraphics[scale=1]{em}

Vi börjar med att lägga till ett e följt av ett m utan problem. När vi sedan lägger till ett i stöter vi på ett problem och det sker en enkel rotation.

\includegraphics[scale=0.7]{emi}
\end{document}
