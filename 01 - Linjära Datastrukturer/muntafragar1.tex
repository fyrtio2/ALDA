...
\begin{itemize}
\item Diskutera fördelar respektive nackdelar mellan enkellänkade och dubbellänkade listor.
\item Ge exempel på när det kan vara nödvändigt att använda sig av queues. Motivera.
\item Förklara skillnaden mellan stack och queue.
\item Förklara hur du skulle implementera en funktion som återger storleken på en lista.
\item Varför är indexering i en arraybaserad lista enklare än i en länkad lista?
\item Förklara hur borttagning av objekt fungerar i olika datastrukturer.
\item Förklara varför kontroll av paranteser är fördelaktigt med stacken.
\end{itemize}
