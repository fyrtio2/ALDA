...
\section*{Muntafrågor}
\begin{enumerate}
\item Ge exempel på situationer då det kan vara användbart att använda sig av prioritetsköer
\item Ge exempel på olika sätt att implementera en prioritetskö, samt redogör fördelar och nakdelar med de olika metoderna.
\item En prioritetskö använder sig av två metoder, instert och deleteMin. Förklara vad dessa metoder gör och hur det går till.
\item 
