...
\section*{Muntafrågor}
\begin{enumerate}
\item Förklara vad som händer vid en kollision, ge exempel på metoder som hanterar problemet, samt förklara hur de fungerar.
\item De två vanligaste metoderna för att lösa kollision är separate chaining och open adressing. Förklara hur dessa fungerar samt ge fördelar och nackdelar.
\item 
\item 
